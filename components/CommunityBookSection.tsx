        ...
        <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex items-center gap-1 cursor-pointer">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <Star
                      key={star}
                      className={cn("w-5 h-5 transition-colors", (hoverRating || rating) >= star ? "fill-primary text-primary" : "text-muted-foreground")}
          ...
          <div className="space-y-4 border-b border-border/50 pb-6">
            <div className="flex items-start justify-between">
              ...
              <div className="flex">
                {[1,2,3,4,5].map(star => (
                   <Star key={star} className={cn("w-4 h-4", star <= 4 ? "fill-primary text-primary" : "text-muted")} />
                ))}
              </div>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-muted/10 border border-border/40 p-5 rounded-xl text-center">
            ...
            <div className="flex justify-center gap-1 mb-2">
               {[1,2,3,4].map(star => <Star key={star} className="w-5 h-5 fill-primary text-primary" />)}
