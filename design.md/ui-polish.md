...
Use token-first styling for product UI implementation:

- Define reusable visual values in `app/globals.css` variables
- Prefer semantic classes over repeated one-off values in TSX
- Avoid hardcoded animation timings/colors when token equivalents exist

Reference: `design.md/design-system.md`
